...
class Ui_Calender1(object):
    def setupUi(self, Calender):
        ...
        self.event_detail_2.setStyleSheet("background-color: rgb(98, 114, 164)")
        ...
        self.check_button_2.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0.511364, x2:1, y2:0.523, stop:0 rgba(254, 121, 199, 255), stop:1 rgba(170, 85, 255, 255));")
...
"background:rgb(126, 143, 255);")
        ...
        self.calendar_3.setStyleSheet("background:rgb(0,0,0);\n"
"color:rgb(255, 0, 255);\n"
...
"selection-color: rgb(0, 85, 127);")
        ...
        self.submit_2.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0.511364, x2:1, y2:0.523, stop:0 rgba(254, 121, 199, 255), stop:1 rgba(170, 85, 255, 255));")
        ...
        self.dele.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0.511364, x2:1, y2:0.523, stop:0 rgba(254, 121, 199, 255), stop:1 rgba(170, 85, 255, 255));")
